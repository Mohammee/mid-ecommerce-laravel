                    ...
                    <div class="panel-body" style="padding-top:0;">
                        <ul style="margin-bottom: 10px">
                            @foreach($products as $product)
                                ...
                                <li>
                                    ...
                                    <div>Product price: ${{ $product->parsePrice() }}</div>
                        ...
                        @foreach($dataType->readRows as $row)
                            ...
                            <div class="panel-body" style="padding-top:0;">
                                ...
                                @else
                                    @include('voyager::multilingual.input-hidden-bread-read')
                                    <p>{{ $row->getTranslatedAttribute('display_name') == 'Billing Subtotal'
                                                    || $row->getTranslatedAttribute('display_name') == 'Billing Total'
                                                     || $row->getTranslatedAttribute('display_name') == 'Billing Tax'? '$' . $dataTypeContent->{$row->field} : $dataTypeContent->{$row->field} }}</p>
                                @endif
                            </div><!-- panel-body -->
                            @if(!$loop->last)
                                <hr style="margin:0;">
