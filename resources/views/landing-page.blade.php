...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <title>{{ config('app.name') }} | DEV.Mohammad Sultan </title>
...
{{--                </ul>--}}
        ...
        <div class="featured-section">
            ...
            <div class="container">
                ...
                <p class="section-description">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolore vitae nisi, consequuntur illum dolores cumque pariatur quis provident deleniti nesciunt officia est reprehenderit sunt
