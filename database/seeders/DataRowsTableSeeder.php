...
//        $menusDataType = DataType::where('slug', 'menus')->firstOrFail();
...
//        $dataRow = $this->dataRow($menusDataType, 'id');
//        if (!$dataRow->exists) {
//            $dataRow->fill([
//                'type'         => 'number',
//                'display_name' => __('voyager::seeders.data_rows.id'),
...
//        }
//
//        $dataRow = $this->dataRow($menusDataType, 'name');
//        if (!$dataRow->exists) {
//            $dataRow->fill([
//                'type'         => 'text',
//                'display_name' => __('voyager::seeders.data_rows.name'),
...
//        }
//
//        $dataRow = $this->dataRow($menusDataType, 'created_at');
//        if (!$dataRow->exists) {
//            $dataRow->fill([
//                'type'         => 'timestamp',
//                'display_name' => __('voyager::seeders.data_rows.created_at'),
...
//        }
//
//        $dataRow = $this->dataRow($menusDataType, 'updated_at');
//        if (!$dataRow->exists) {
//            $dataRow->fill([
//                'type'         => 'timestamp',
//                'display_name' => __('voyager::seeders.data_rows.updated_at'),
